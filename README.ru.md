...
1. Mac OS: запустите команду в терминале brew install sass/sass/sass
2. For Windows используйте етот линк https://sass-lang.com/install

## Робота із SASS
Откройте терминал и запустите команду sass --watch scss/main.scss:css/styles.css
